                        ...
                        >
                            ...
                            <div className="glass group/card rounded-2xl p-5 ring-1 ring-white/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-pink-500/30 hover:ring-pink-400/40">
                                ...
                                <div className="mt-3 flex flex-wrap gap-2 text-[11px] text-white/80">
                                    {p.genre && (
                                        <span className="rounded-full border border-pink-300/20 bg-pink-500/10 px-2 py-1">
                                            {p.genre}
                                        </span>
                                    )}
                                    {p.duration && (
                                ...
                                <div className="mt-4">
                                    <Link
                                        to={`/pieces/${p.slug}`}
                                        className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full border border-white/15 bg-white/5 px-4 py-2 transition-all duration-300 hover:border-pink-400/30 hover:shadow-lg hover:shadow-pink-500/20"
                                    >
                                        {/* Dégradé animé en arrière-plan */}
                                        <div className="absolute inset-0 origin-center scale-x-0 rounded-full bg-gradient-to-r from-pink-500/80 via-rose-500/80 to-red-500/80 opacity-0 transition-all duration-500 ease-out group-hover:scale-x-100 group-hover:opacity-100" />
                                        ...
                                        <svg
                                            viewBox="0 0 24 24"
                                            className="relative z-10 h-4 w-4 transition-all duration-300 group-hover:translate-x-1 group-hover:text-white"
                                            fill="none"
                                            stroke="currentColor"
                                            strokeWidth="2"
                                        >
